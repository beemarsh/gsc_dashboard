  ...
  <div class="dialog-backdrop" @click="$emit('close')">
    <div class="dialog-content" @click.stop>
      <div class="dialog-header">
        <h3>{{ editMode ? 'Edit' : 'Add' }} Partner</h3>
      ...
      <form class="dialog-body">
        ...
        <div class="dialog-footer">
          ...
          >
            ...
            {{ isSubmitting ? (editMode ? 'Updating...' : 'Adding...') : (editMode ? 'Update Partner' : 'Add Partner') }}
          </button>
        </div>
      </form>
    </div>
...
export default defineComponent({
  ...
  created() {
    if (this.editMode && this.partnerData) {
      this.formData = {
        organization_name: this.partnerData.organization_name,
        contact_person: this.partnerData.contact_person,
        contact_email: this.partnerData.contact_email,
        phone_number: this.partnerData.phone_number,
        address: this.partnerData.address,
        type: this.partnerData.type.toLowerCase(),
        notes: this.partnerData.notes || ''
      }
    }
  },
  methods: {
